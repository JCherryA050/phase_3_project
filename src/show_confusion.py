...
def plot_confusion(X_train,X_test,y_train,y_test,model):
    ...
    cf_matrix_train = confusion_matrix(y_train, y_hat_train)
    cf_matrix_test = confusion_matrix(y_test, y_hat_test)

    # label parameters and calls function to plot matrix based on array above
    categories = ['Non-functional', 'Functional Needs Repair', 'Functional']
    make_confusion_matrix(cf_matrix_train, categories = categories, figsize = (8, 6))
    plt.xticks(rotation=25)
    make_confusion_matrix(cf_matrix_test, figsize = (8, 6), categories = categories)
    plt.xticks(rotation=25)        